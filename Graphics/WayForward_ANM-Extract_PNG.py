...
SpriteName = "2" # The name of the .ANM, .AN4 or .AN8 file (if UseGBAROM = False) and the sprite tileset PNG file, minus the extensions. Will also be the name of the folder said sprites will extract to. (Example: "20" will be Shantae's ANM filename when using my QuickBMS script to unpack Shantae Advance: Risky Revolution.)
